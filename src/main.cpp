...
int main()
{
    ...
    while (fenetre.isOpen())
    {
        ...
        while (fenetre.pollEvent(event))
        {
            ...
            if (plateau(pos_click_depart) != nullptr )
            {
                ...
                if (fenetre.effectuerActionClic(pos_click_button) == 1 && perso_selectionne->getPeutDeplacer() == true && plateau(pos_click_depart)->getJoueur() == joueur)
                {
                ...
                else if (fenetre.effectuerActionClic(pos_click_button) == 2 && perso_selectionne->getPeutAttaquer() == true && plateau(pos_click_depart)->getJoueur() == joueur)
                {
                ...
                else if (fenetre.effectuerActionClic(pos_click_button) == 3 && plateau(pos_click_depart)->getTourFini() == false && plateau(pos_click_depart)->getJoueur() == joueur)
                {
