...
{
	sf::Texture guerrier_bleu,guerrier_rouge;
	guerrier_bleu.loadFromFile("images/soldat_bleu/soldat_B.png");
	guerrier_rouge.loadFromFile("images/paladin_rouge/paladin.png");
	_peut_attaquer = true;
	_peut_deplacer = true;
	_tour_fini = false;
	...
	if (getJoueur()=='B')
	{
		if (getType()=='G')
		{
			setSpriteTexture(guerrier_bleu);
		}
		else
		{
			/*autre classe comme mage*/
		}
	}
	//si personnage Bleu
	else
	{
		if (getType()=='G')
		{
			setSpriteTexture(guerrier_rouge);
		}
		else
		{
			/*autre classe comme mage*/
...
{
	sf::Texture texture_fini_Guerrier_R,texture_fini_Guerrier_B;
	texture_fini_Guerrier_R.loadFromFile("images/paladin_rouge/paladin_tour_fini.png");
	texture_fini_Guerrier_B.loadFromFile("images/soldat_bleu/soldat_B_tour_fini.png");



	if ((_peut_deplacer==false && _peut_attaquer==false)|| _tour_fini==true)
	{
		_tour_fini=true;
		if (getJoueur()=='B')
		{
			if (getType()=='G')
			{
				setSpriteTexture(texture_fini_Guerrier_B);
			}
		}
		else
		{
			if (getType()=='G')
			{
				setSpriteTexture(texture_fini_Guerrier_R);
			}
		}
	}
}
